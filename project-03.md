...
* **Use a CSS Framework** for layout and basic styling. _You should customise the style once the app is complete_

You should also include a 3rd-party API, although you should not base your entire app around an API. It should be a added feature.

Be aware that you may need to apply for API keys, which may take some time to arrive.

**Remember**: DO NOT ADD YOUR API KEYS DIRECTLY TO GITHUB. USE ENVIRONMENT VARIABLES!
